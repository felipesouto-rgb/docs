...
<Warning>
  **Sell Side** é cliente do IBaaS (origina). **Enterprise** é cliente de plataforma (opera sob marca própria). **Buy Side** NÃO é cliente do IBaaS — é o lado comprador do mercado e fonte de demanda. Cada um tem uma página própria; nunca tratar Buy Side como cliente nem Enterprise como Buy Side.
</Warning>
