...
<CardGroup cols={2}>
  <Card title="Bloxs Workspace" color="#033873" icon="display" href="/ferramentas/workspace/index">
    A Plataforma IBaaS — o produto onde parceiros, buy side e Enterprise operam.
  </Card>

  <Card title="Infraestrutura" color="#2E61FF" icon="plug" href="/ferramentas/infra/index">
    O stack de apoio que roda a casa por dentro — HubSpot, Google, ClickUp e cia.
  </Card>

  <Card title="Como a Máquina Gira" color="#033873" icon="gears" href="/maquina/revops">
    RevOps, dados e integrações que costuram o Workspace ao restante da operação.
  </Card>
</CardGroup>