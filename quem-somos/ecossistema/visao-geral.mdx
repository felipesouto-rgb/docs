...
**Não é cliente do IBaaS — é o consumidor do ecossistema.** Compra os deals, fundos e estruturas. Valida o preço e dá saída à operação. Não é canal de varejo — é confirmação de apetite institucional real.
...
<CardGroup cols={2}>
  <Card title="Sell Side em detalhe" icon="arrow-up-right-dots" href="/quem-somos/ecossistema/sell-side">
  </Card>

  <Card title="Buy Side em detalhe" icon="magnifying-glass-dollar" href="/quem-somos/ecossistema/buy-side">
  </Card>

  <Card title="Enterprise em detalhe" icon="building" href="/quem-somos/ecossistema/enterprise">
  </Card>
